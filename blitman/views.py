...
def parse_html(request):
    ...
    if '<hr class="dashed-line">' not in existing_html:
        ...
        r = requests.get("https://menus.sodexomyway.com/BiteMenu/Menu?menuId=15288&locationId=76929015&whereami=http://rpi.sodexomyway.com/dining-near-me/commons-dining-hall")
        ...
        for course in courses:
            ...
            for item in items:
                ...
                if item_name and calories:
                    ...
                    modified_html += f'\t\t<button style="font-size: 20px; margin-top: 20px; margin-left: 35px">{item_name} {calories.group()}</button>\n\t\t<hr class="dashed-line">\n'
...
def blitman(request):
    return render(request, 'bitman/bitman.html')
